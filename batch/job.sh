...
#set job parameters
data_name="alldata"
main_dir="/Volumes/healthcare/thesis/LinearProgramming/riskSLIM"
data_file="/Volumes/healthcare/local_thesis_files/18_3_2_SLIMProcessedData.csv"

cvindices_file="/Volumes/healthcare/local_thesis_files/18_3_2_SLIMProcessedData_folds.csv"
...
run_name="${data_name}_fold${fold}"
run_time=$(date +"%m_%d_%Y_%H_%M_%S")
results_file="${main_dir}/${run_name}_results.p"
log_file="${main_dir}/${run_name}_${run_time}.log"
...
#settings_file="settings_template.json"
